$(document).ready(function(){
	...
	*/
	$('#button_add_tag').on('click',  function(event){
		...
		if(text != ""){
			...
			$.ajax({
				url: 'http://localhost:8092/get_tag_findTextTag',
				type: 'POST',
				...
				success: function(data){
					if(data != null){
						...
						$.ajax({
							url: 'http://localhost:8092/save_tag',
							type: 'POST',
							dataType: 'json',
							data: {tag: text},
							success: function(data){
			...
			$.ajax({
				...
				success: function(data){
					if(data != null){
						...
						$.ajax({
							url: 'http://localhost:8092/update_tag',
							type: 'POST',
	...
	*/
	$('#button_delete_delete').on('click',  function(event){
		...
		$.ajax({
			url: 'http://localhost:8092/delete_tag',
			type: 'POST',
			data: {id: idUpdateTeg} // 
		});
		...
		$.ajax({
			url: 'http://localhost:8092/delete_tag_all_act',
			type: 'POST',
